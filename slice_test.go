...
var result Person    // Global variable to prevent compiler optimization
...
func BenchmarkStackAllocation(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		...
		result = p // Store in global to prevent optimization
	}
}
...
func BenchmarkHeapAllocation(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		...
		resultPtr = p // Store in global to prevent optimization
	}
}
